...
public class auge : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        scope_camera_auge.SetActive(true);



        ani.SetInteger("auge", 0);
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.708f;
            ani.SetInteger("auge", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        {
            reload_time = 1.958f;
            ani.SetInteger("auge", 3); // empty reload
    ...
    public GameObject scope_camera_auge;
    ...
    public void turn_off_weapon()
    {
        ...
        scope_camera_auge.SetActive(false);
    }
