...
public class assault57 : MonoBehaviour
{
   ...
   public Vector3 _3rd_view_cam;
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.2581f;
            ani.SetInteger("assault57", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
