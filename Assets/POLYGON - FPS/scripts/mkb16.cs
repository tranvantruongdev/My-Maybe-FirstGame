...
public class mkb16 : MonoBehaviour
{
   ...
   public void Start()
    ...
    void Update()
    {
        ...
        if (button_aim && !button_shoot && !in_reload)
        {
            ...
            ani.SetInteger("mkb16", 4);
        }
        if (!button_aim && !button_shoot && !in_reload)
        {
            // idle animation / animator
            ani.SetInteger("mkb16", 0);
        }
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.416f;
            ani.SetInteger("mkb16", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        {
            reload_time = 1.833f;
            ani.SetInteger("mkb16", 3); // empty reload
    ...
    public void change_equipment()
    {
        ...
        back_sight.transform.localEulerAngles = new Vector3(-181, -179.268f, -180f);
        ...
        if (back_sight_bool)
        {
            back_sight.transform.localEulerAngles = new Vector3(-275.511f, -178.754f, -178.751f);
        }
