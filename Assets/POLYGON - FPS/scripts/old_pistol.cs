...
public class old_pistol : MonoBehaviour
{
   ...
   public void Start()
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.374f;
            ani.SetInteger("old_pistol", 10); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
