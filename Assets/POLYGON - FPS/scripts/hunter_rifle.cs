...
public class hunter_rifle : MonoBehaviour
{
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.708f;
            ani.SetInteger("hunter_rifle", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        {
            reload_time = 1.708f;
            ani.SetInteger("hunter_rifle", 5); // empty reload
