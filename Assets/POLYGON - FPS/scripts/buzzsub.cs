...
public class buzzsub : MonoBehaviour
{
   ...
   public void Start()
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.2581f;
            ani.SetInteger("buzzsub", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        else
        {
            ...
            ani.SetInteger("buzzsub", 3); // empty reload
    ...
    public float sight_a_rot_;
    public float sight_a_rot_on_scope;

    public GameObject sight_b;
    public float sight_b_rot_;
    public float sight_b_rot_on_scope;
    ...
    public void change_equipment()
    {
       ...
       // shoot position
        ...
        if(scope)
        {
              sight_a.transform.localEulerAngles =  new Vector3(sight_a_rot_on_scope, 89.99999f, 0);
              sight_b.transform.localEulerAngles = new Vector3(sight_b_rot_on_scope, 89.99999f, 0);
        }
        else
        {
              sight_a.transform.localEulerAngles = new Vector3(-89.55601f, 89.99999f, 0 );
              sight_b.transform.localEulerAngles = new Vector3(-90.00001f, 0, 90.00001f);
        }
