...
public class tarusk : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (button_aim && !button_shoot && !in_reload)
        {
            ...
            ani.SetInteger("tarusk", 4);
        }
        if (!button_aim && !button_shoot && !in_reload)
        {
            // idle animation / animator
            ani.SetInteger("tarusk", 0);
        }
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.791f;
            ani.SetInteger("tarusk", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        {
            reload_time = 2.166f;
            ani.SetInteger("tarusk", 3); // empty reload
    ...
    public bool scope;
    public bool front_sight_bool;
    public bool back_sight_bool;
    ...
    public void change_equipment()
    {
        ...
        front_sight.transform.localEulerAngles = new Vector3(-74, -89, 0.001f);
        back_sight.transform.localEulerAngles = new Vector3(-89, -0.001f, -89f);
        ...
        {
            front_sight_bool = true;
            back_sight_bool = true;
        ...
        if (front_sight_bool || back_sight_bool)
        {
            front_sight.transform.localEulerAngles = new Vector3(70f, 47f, -40);
            back_sight.transform.localEulerAngles = new Vector3(-164.141f, -90, -1.525879e-05f);
        }
