...
public class submachine5 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (button_aim && !button_shoot && !in_reload)
        {
            ...
            ani.SetInteger("submachine5", 4);
        }
        if (!button_aim && !button_shoot && !in_reload)
        {
            // idle animation / animator
            ani.SetInteger("submachine5", 0);
        }
    ...
    public IEnumerator reload_start()
    {
        ...
        {
            reload_time = 1.583f;
            ani.SetInteger("submachine5", 5); // unempty reload    - putting aduioclip on new spawned empty object and transform parent it to the point Shoot_start_point for a static sound
        ...
        {
            reload_time = 1.916f;
            ani.SetInteger("submachine5", 3); // empty reload
